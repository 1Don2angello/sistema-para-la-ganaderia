...
<html lang="en">
    <head>
        ...
        <title><?php echo lang('livestock'); ?> | <?php echo lang('livestock_management_system'); ?></title>
        <!-- Bootstrap core CSS -->
    ...
    <body class="login-body">
        <div class="container">
            <form class="form-signin" method="post" action="auth/login">
                <h2 class="login form-signin-heading"><?php echo lang('livestock'); ?> <br> <br> <?php echo lang('livestock_management_system'); ?><br></br><i class=''></i></h2>
                <div id="infoMessage"><?php echo $message; ?></div>
                <div class="login-wrap">
                    <input type="text" class="form-control" name="identity" value="admin@example.com" placeholder="User Email" autofocus>
