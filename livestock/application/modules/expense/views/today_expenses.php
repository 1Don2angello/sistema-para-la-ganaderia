                            ...
                            <tr class="">
                                ...
                                <?php if ($this->ion_auth->in_group('admin')) { ?>
                                    <td>
                                        ...
                                        <a class="btn btn-info btn-xs delete_button width_auto" href="expense/deleteExpense?id=<?php echo $expense->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash-o"></i> <?php echo lang('delete'); ?></a>
                                    </td>
                                <?php } ?>
                            </tr>
                        <?php } ?>
