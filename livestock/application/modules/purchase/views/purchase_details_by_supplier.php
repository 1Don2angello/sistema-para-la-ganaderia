    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            ...
            <header class="panel-heading">
                <i class="fa fa-money"></i>  <?php echo lang('supplier_history'); ?> : <?php echo $this->supplier_model->getSupplierById($supplier_id)->name; ?>  
            </header>

            <div class="">
                <div class="col-md-3 total_title payable"> <p><?php echo lang('payable'); ?></p>  <?php echo $settings->currency; ?> <?php echo number_format($total_payable, 2, '.', ','); ?>  </div> 
                ...
                <div class="col-md-3 total_title due_payable"> <p><?php echo lang('due'); ?>  </p> <?php echo $settings->currency; ?> <?php echo number_format($total_payable - $total_paid, 2, '.', ','); ?>   </div> 
            </div>
            ...
            <div class="panel-body"> 
                <div class="adv-table editable-table ">
                    <div class="clearfix new">
                        <a href="purchase/addPurchaseView?supplier_id=<?php echo $supplier_id; ?>">
                            <div class="btn-group">
                        ...
                        <?php foreach ($purchases as $purchase) { ?>
                            ...
                            <tr class="">
                                ...
                                <td class="option"> 
                                    ...
                                    <?php } ?>
                                    <a class="btn btn-xs viewPayment" data-toggle="modal" data-id="<?php echo $purchase->id; ?>" href="#modal1"><i class="fa fa-eye"></i> <?php echo lang('view_payment'); ?> </a>
                                    <?php // payment/paymentsForPurchaseId?id=<?php echo $purchase->id;      ?>
                                    <a class="btn btn-xs addPayment" data-toggle="modal" data-id="<?php echo $purchase->id; ?>" href="#modal"><i class="fa fa-plus-circle"></i>  <?php echo lang('add_payment'); ?></a>                                   
                                    <?php if ($this->ion_auth->in_group('admin')) { ?> 
                                        <a class="btn btn-xs" href="purchase/delete?id=<?php echo $purchase->id; ?>&supplier_id=<?php echo $supplier_id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash-o"></i>  <?php echo lang('delete'); ?></a>
                                    <?php } ?>
                                    </button>
                                </td>
                            </tr>
