                            ...
                            <tr class="">
                                ...
                                <td> <?php
                                    if ($sale->sale_status == 'delivered') {
                                        echo "<div class='btn-info' style='width:90px; padding:5px;'>". lang('delivered') ."</div>";
                                    } else {
                                ...
                                <td class="option">   
                                    ...
                                    <a class="btn btn-xs addPayment" data-toggle="modal" data-id="<?php echo $sale->id; ?>" data-client_id="<?php echo $sale->client_id; ?>" href="#modal"><i class="fa fa-plus-circle"></i> <?php  echo lang('add_payment'); ?></a>   
                                    <a class="btn btn-xs" href="sale/invoice?id=<?php echo $sale->id; ?>"><i class="fa fa-file-text"></i> <?php  echo lang('invoice'); ?></a>
                                    <?php if ($this->ion_auth->in_group('admin')) { ?> 
                                        <a class="btn btn-xs" href="sale/delete?id=<?php echo $sale->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash-o"></i>  <?php  echo lang('delete'); ?></a>
                                    <?php } ?>
                                    </button>
                                </td>
                            </tr>
